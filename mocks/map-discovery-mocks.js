...
exports.xyzMapDiscovery = {
  format: 'xyz',
  valid: true
};

exports.invalidXyzMapDiscovery = {
  format: 'xyz',
  valid: false
};

exports.validNoFormatMapDiscovery = {
  valid: true
};
...
exports.wmsMapDiscovery = {
  "url": "http://watzmann.geog.uni-heidelberg.de/cached/osm",
  "valid": true,
  "format": "wms",
  "wmsGetCapabilities": exports.wmsGetCapabilities
};
